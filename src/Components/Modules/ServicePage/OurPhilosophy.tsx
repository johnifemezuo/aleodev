...
const SecCard = ({title, description, image}:{title: string; description?: string; image: string}) => {
    return (
        <div className='rounded-xl lg:flex lg:space-x-4 bg-white p-5 relative w-full '>
            ...
            <Image width={120} height={120} src={image} alt={title} className='text-primary w-[45px] h-[45px]' />
            </div>
