    ...
    <div className='py-20 lg:py-32 bg-dark w-full relative overflow-hidden '>
        <Container>
            <div className='space-y-9 relative z-30 px-4 xl:px-0'>
                ...
                <h3 className='uppercase text-zinc-300 text-sm lg:text-base font-medium'>WHY WORK WITH US</h3>
                <Title>Why <span className='text-primary'>Brands</span>  Like Yours Strive To <span className='text-primary'>Work With Us</span></Title>
                </div>
        ...
        <Image src="/images/wff.png" alt="" width={800} height={800} className='absolute right-0 inset-y-0 z-0 w-[900px] h-full' />
</div>
  )
}
