...
export const WorkHero = () => {
  return (
    <div className="bg-dark w-full lg:h-screen xl:h-[90vh] overflow-hidden">
      <Container>
        <div className="space-y-4 px-6  xl:px-0 relative z-20 py-40 md:py-44 lg:py-52 flex mx-auto lg:flex-row flex-col lg:space-x-20 items-center">
          <div>
            ...
            <h4 className="text-lg lg:text-xl text-white/70">Our Work</h4>
      ...
      <div className="lg:translate-y-20 xl:-mt-44  z-20    overflow-hidden relative">
        <div className="flex items-center px-2 space-x-4 w-[1200px] lg:w-full overflow-scroll">
        <Image
          src="/images/img1.png"
          alt=""
          className="w-"
